...
//        }
        ...
        withAnimationView("Tests/DynamicText.json", "Dynamic Text", "layer name different than text") { animationView ->
            val textDelegate = TextDelegate(animationView)
            animationView.setTextDelegate(textDelegate)
            textDelegate.setText("NAME", "Layer named Name")
            textDelegate.setText("Name Not matching Text", "NAME", "Some Other Name " + Random.nextDouble())
        }
    }
