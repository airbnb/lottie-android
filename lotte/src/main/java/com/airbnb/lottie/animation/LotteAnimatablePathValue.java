...
import com.airbnb.lottie.utils.LottePathKeyframeAnimation;
...
public class LotteAnimatablePathValue implements LotteAnimatableValue<PointF> {
    ...
    public LotteAnimatablePathValue(JSONObject pointValues, int frameRate, long compDuration) {
    ...
    public LotteKeyframeAnimation animationForKeyPath() {
        ...
        LotteKeyframeAnimation<PointF> animation = new LottePathKeyframeAnimation(duration, compDuration, keyTimes, animationPath, interpolators);
    ...
    public String toString() {
        return "LotteAnimatablePathValue{" + "initialPoint=" + initialPoint + '}';
    }
}
