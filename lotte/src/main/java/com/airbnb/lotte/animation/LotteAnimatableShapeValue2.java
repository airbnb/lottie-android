...
public class LotteAnimatableShapeValue2 implements LotteAnimatableValue<Path> {
    ...
    public LotteAnimatableShapeValue2(JSONObject shapeValues, int frameRate, long compDuration, boolean closed) {
