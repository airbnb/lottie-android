...
public class LottieAnimationView extends AppCompatImageView {
    ...
    private LottieCompositionListener lottieCompositionListener;
    ...
    public void setAnimation(@RawRes final int rawRes) {
        ...
        animationName = null;
        LottieComposition cachedComposition = LottieCompositionCache.getInstance()
                                                                    .getRawRes(rawRes);
    ...
    public void setComposition(@NonNull LottieComposition composition) {
        ...
        if(lottieCompositionListener != null) {
            lottieCompositionListener.onCompositionLoaded();
        }
    }
    ...
    public void setLottieCompositionListener(LottieCompositionListener lottieCompositionListener) {
        this.lottieCompositionListener = lottieCompositionListener;
    }
