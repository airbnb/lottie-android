...
public class TextLayer extends BaseLayer {
  ...
  private void offsetCanvas(Canvas canvas, DocumentData documentData, int lineIndex, float lineWidth) {
    ...
    float dpScape = Utils.dpScale();
    float lineStartY = position == null ? 0f : position.y + documentData.lineHeight * dpScape / 2;
    float lineOffset = (lineIndex * documentData.lineHeight * dpScape) + lineStartY;
